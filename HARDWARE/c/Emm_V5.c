...
void Emm_V5_Reset_Clog_Pro(uint8_t addr)
{
  ...
  // 发送命令
  uart_putbuff(Emm_V5_USART, cmd, 4);
}
...
void Emm_V5_Read_Sys_Params(uint8_t addr, SysParams_t s)
{
  ...
  // 发送命令
  uart_putbuff(Emm_V5_USART,cmd, i);
}
...
void Emm_V5_Modify_Ctrl_Mode(uint8_t addr, bool svF, uint8_t ctrl_mode)
{
  ...
  // 发送命令
  uart_putbuff(Emm_V5_USART,cmd, 6);
    delay_ms(5);
}
...
void Emm_V5_Stop_Now(uint8_t addr, bool snF)
{
  ...
  // 发送命令
  uart_putbuff(Emm_V5_USART,cmd, 5);
}
...
void Emm_V5_Origin_Modify_Params(uint8_t addr, bool svF, uint8_t o_mode, uint8_t o_dir, uint16_t o_vel, uint32_t o_tm, uint16_t sl_vel, uint16_t sl_ma, uint16_t sl_ms, bool potF)
{
  ...
  // 发送命令
 uart_putbuff(Emm_V5_USART,cmd, 20);
}
...
void motor_read_all(void)
{
    Emm_V5_Read_Encoder(1);
    Emm_V5_Read_Encoder(2);
    Emm_V5_Read_Encoder(3);
    Emm_V5_Read_Encoder(4);
}

void no_pid(void)
{
    Emm_V5_Modify_Ctrl_Mode(1, 0, 1);
    Emm_V5_Modify_Ctrl_Mode(2, 0, 1);
    Emm_V5_Modify_Ctrl_Mode(3, 0, 1);
    Emm_V5_Modify_Ctrl_Mode(4, 0, 1);
}
